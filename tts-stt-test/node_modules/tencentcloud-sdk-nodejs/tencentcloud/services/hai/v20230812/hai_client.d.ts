...
import { InquirePriceRunInstancesResponse, ResizeInstanceDiskResponse, StopInstanceRequest, DescribeServiceLoginSettingsResponse, ResetInstancesPasswordResponse, DescribeInstanceNetworkStatusResponse, UpdateServiceConfigsRequest, TerminateInstancesRequest, InquirePriceUpdateServiceConfigsRequest, DescribeServicesResponse, TerminateInstancesResponse, RunInstancesResponse, DescribeRegionsRequest, StartInstanceRequest, CreateInferServiceByTemplateResponse, ResizeInstanceDiskRequest, DescribeDeployTemplatesResponse, DeployInferServiceResponse, DescribeMuskPromptsRequest, DescribeScenesResponse, DescribeApplicationsRequest, InquirePriceUpdateServiceConfigsResponse, CreateApplicationRequest, ResetInstancesPasswordRequest, RunInstancesRequest, DescribeDeployTemplatesRequest, DescribeInstancesResponse, UpdateServiceConfigsResponse, DescribeInstancesRequest, DescribeServiceLoginSettingsRequest, DescribeScenesRequest, DescribeRegionsResponse, DescribeServicesRequest, DeployInferServiceRequest, StartInstanceResponse, CreateMuskPromptResponse, CreateInferServiceByTemplateRequest, CreateApplicationResponse, DescribeModelsResponse, DescribeModelsRequest, CreateMuskPromptRequest, DescribeApplicationsResponse, InquirePriceRunInstancesRequest, DescribeInstanceNetworkStatusRequest, StopInstanceResponse, DescribeMuskPromptsResponse } from "./hai_models";
/**
 * hai client
 * @class
 */
