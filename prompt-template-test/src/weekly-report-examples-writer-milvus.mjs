    ...
    if (!hasCollection.value) {
      ...
      await client.createCollection({
        ...
        fields: [
          ...
          { name: 'scenario', data_type: DataType.VarChar, max_length: 2000 },
          { name: 'report_snippet', data_type: DataType.VarChar, max_length: 10000 },
...
async function insertExamples() {
  try {
    ...
    const insertedCount = Number(insertResult.insert_cut) || 0
