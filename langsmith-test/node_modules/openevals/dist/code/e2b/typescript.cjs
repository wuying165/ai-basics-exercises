...
exports.createE2BTypeScriptEvaluator = void 0;
const base_js_1 = require("../base.cjs");
const files_js_1 = require("./sandbox/files.cjs");
const E2B_COMMAND = [
    `echo '${files_js_1.PACKAGE_JSON_FILE}' > package.json`,
    `echo '${files_js_1.TYPESCRIPT_EVALUATOR_FILE}' > check_typescript.js`,
    `echo '${files_js_1.EXTRACT_IMPORT_NAMES}' > extract_import_names.js`,
 ...
 */
function createE2BTypeScriptEvaluator(config) {
    ...
    const _scorer = async (params) => {
        ...
        try {
            ...
            if (res.stdout.includes(files_js_1.TYPESCRIPT_EVALUATOR_SEPARATOR)) {
                return JSON.parse(res.stdout.split(files_js_1.TYPESCRIPT_EVALUATOR_SEPARATOR)[1]);
            }
...
exports.createE2BTypeScriptEvaluator = createE2BTypeScriptEvaluator;
