 ...
 */
export function _normalizeContentBlocks(blocks) {
    try {
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        const msg = new HumanMessage({ content: blocks });
 ...
 */
export function _attachmentToContentBlock(item) {
