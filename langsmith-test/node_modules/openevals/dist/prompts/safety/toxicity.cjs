...
exports.TOXICITY_PROMPT = void 0;
exports.TOXICITY_PROMPT = `You are an expert content moderator evaluating opinions for toxicity. Your task is to determine whether EACH opinion is toxic and provide your assessment.
