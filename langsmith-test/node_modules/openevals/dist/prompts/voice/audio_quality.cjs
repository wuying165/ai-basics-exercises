...
exports.AUDIO_QUALITY_PROMPT = void 0;
exports.AUDIO_QUALITY_PROMPT = `You are an expert audio quality evaluator. You will be provided with metadata or signals from an audio recording.
