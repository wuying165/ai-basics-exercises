...
exports.USER_INTERRUPTS_PROMPT = void 0;
exports.USER_INTERRUPTS_PROMPT = `You are an expert conversation evaluator. You will be provided with a voice recording of a conversation between a user and an AI agent.
