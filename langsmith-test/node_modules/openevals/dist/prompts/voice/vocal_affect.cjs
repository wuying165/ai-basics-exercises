...
exports.VOCAL_AFFECT_PROMPT = void 0;
exports.VOCAL_AFFECT_PROMPT = `You are an expert voice quality evaluator. You will be provided with the audio for a conversation between an agent and a user.
