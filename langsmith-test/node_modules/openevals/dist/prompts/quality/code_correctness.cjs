...
exports.CODE_CORRECTNESS_PROMPT_WITH_REFERENCE_OUTPUTS = exports.CODE_CORRECTNESS_PROMPT = void 0;
exports.CODE_CORRECTNESS_PROMPT = `You are an expert code reviewer evaluating code for correctness. Your task is to assign a score based on the following rubric:
...
`;
exports.CODE_CORRECTNESS_PROMPT_WITH_REFERENCE_OUTPUTS = `You are an expert code reviewer evaluating code for correctness. Your task is to assign a score based on the following rubric:
