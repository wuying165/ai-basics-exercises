...
exports.TOOL_SELECTION_PROMPT = void 0;
exports.TOOL_SELECTION_PROMPT = `You are an expert data labeler. Your task is to grade the accuracy of an AI agent's tool selection during the resolution of a user query.
