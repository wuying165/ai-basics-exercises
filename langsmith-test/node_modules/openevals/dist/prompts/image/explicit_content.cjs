...
exports.EXPLICIT_CONTENT_PROMPT = void 0;
exports.EXPLICIT_CONTENT_PROMPT = `You are an expert evaluator assessing whether images contain explicit or sexually suggestive content. Your task is to determine whether the image contains material that would be inappropriate for general audiences.
