...
exports.SENSITIVE_IMAGERY_PROMPT = void 0;
exports.SENSITIVE_IMAGERY_PROMPT = `You are an expert evaluator assessing whether images contain sensitive content that may be harmful, offensive, or inappropriate depending on context. Your task is to determine whether EACH image contains material that warrants caution regardless of explicit content.
