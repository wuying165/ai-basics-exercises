...
exports.KNOWLEDGE_RETENTION_PROMPT = void 0;
exports.KNOWLEDGE_RETENTION_PROMPT = `You are an expert conversation evaluator. You will be shown a full conversation between a human user and an AI agent.
