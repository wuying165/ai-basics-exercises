...
exports.USER_SATISFACTION_PROMPT = void 0;
exports.USER_SATISFACTION_PROMPT = `You are an expert conversation evaluator. You will be shown a full conversation between a human user and an AI assistant.
