...
exports.PERCEIVED_ERROR_PROMPT = void 0;
exports.PERCEIVED_ERROR_PROMPT = `You are an expert evaluator analyzing user messages in a conversation to detect whether the user perceives the agent has made an error or is heading in the wrong direction. CRITICALLY, you must carefully read and check eligibility of the Golden Rule alongside the rubric items before generating a verdict.
