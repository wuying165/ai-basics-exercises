...
exports.TASK_COMPLETION_PROMPT = void 0;
exports.TASK_COMPLETION_PROMPT = `You are an expert conversation evaluator. You will be shown a full conversation between a human user and an AI agent.
