...
exports.SUPPORT_INTENT_PROMPT = void 0;
exports.SUPPORT_INTENT_PROMPT = `You are an expert conversation evaluator. You will be shown a full conversation between a human user and an AI customer support assistant.
