...
exports.RAG_GROUNDEDNESS_PROMPT = void 0;
exports.RAG_GROUNDEDNESS_PROMPT = `You are an expert data labeler assessing how well LLM output aligns with and is supported by the retrieved context. Your evaluation should focus on the following criteria:
