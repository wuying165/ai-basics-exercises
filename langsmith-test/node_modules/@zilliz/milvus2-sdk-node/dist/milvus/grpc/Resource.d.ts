...
import { ResStatus, GrpcTimeOut, CreateResourceGroupReq, DropResourceGroupsReq, ListResourceGroupsResponse, DescribeResourceGroupsReq, DescribeResourceGroupResponse, UpdateRresourceGroupReq, TransferNodeReq, TransferReplicaReq, UpdateReplicateConfigurationReq, GetReplicateConfigurationReq, GetReplicateConfigurationResponse } from '../';
export declare class Resource extends Partition {
    ...
    update_replicate_configuration: (data: UpdateReplicateConfigurationReq) => Promise<ResStatus>;
    get_replicate_configuration: (data?: GetReplicateConfigurationReq) => Promise<GetReplicateConfigurationResponse>;
    /**
