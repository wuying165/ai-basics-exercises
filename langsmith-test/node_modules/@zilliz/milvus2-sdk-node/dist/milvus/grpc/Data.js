...
class Data extends Collection_1.Collection {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            data.fields_data.forEach((rowData, rowIndex) => {
                ...
                fieldNames.forEach(name => {
                    ...
                    const fieldData = (0, __1.buildFieldData)(rowData, field, data.transformers, rowIndex);
                    if (field.type === __1.DataType.BinaryVector && fieldData != null) {
                        if (fieldData.length !== field.dim / 8) {
                            throw new Error(__1.ERROR_REASONS.INSERT_CHECK_WRONG_DIM);
                        }
                    }
                    if (field.nullable !== true &&
                        (field.type === __1.DataType.BinaryVector ||
                            field.type === __1.DataType.FloatVector)) {
                        field.data.push(...fieldData);
                    }
                    else {
            ...
            const buildColumnData = (fields) => {
                ...
                return Array.from(fields.values()).map(field => {
                    var _a;
                    let key = [...__1.VectorDataTypes, __1.DataType.ArrayOfVector].includes(field.type)
                        ? 'vectors'
                        : 'scalars';
                    ...
                    const needValidData = field.nullable === true ||
                        (key !== 'vectors' &&
                    ...
                    const valid_data = needValidData
                        ...
                        : [];
                    const physicalData = field.nullable === true && __1.VectorDataTypes.includes(field.type)
                    ...
                    switch (field.type) {
                        ...
                        case __1.DataType.Float16Vector:
                            keyValue = {
                                dim: field.dim,
                                [dataKey]: Buffer.concat(physicalData),
                            };
                            break;
                        case __1.DataType.BinaryVector:
                            keyValue = {
                                dim: field.dim,
                                [dataKey]: (0, __1.f32ArrayToBinaryBytes)(physicalData.flat()),
                            };
                            break;
                        case __1.DataType.SparseFloatVector:
                            const dim = field.dim || (0, __1.getSparseDim)(physicalData);
                            keyValue = {
                                dim,
                                [dataKey]: {
                                    dim,
                                    contents: (0, __1.sparseRowsToBytes)(physicalData),
                                },
                            };
                            break;
                        case __1.DataType.Int8Vector:
                            keyValue = {
                                dim: field.dim,
                                [dataKey]: (0, __1.int8VectorRowsToBytes)(physicalData),
                            };
                            break;
                        case __1.DataType.ArrayOfVector: {
                            const buildVectorArrayData = (vector) => {
                                switch (field.elementType) {
                                    ...
                                    case __1.DataType.BinaryVector:
                                        return {
                                            dim: field.dim,
                                            [elementTypeKey]: (0, __1.f32ArrayToBinaryBytes)(vector),
                                        };
                                    case __1.DataType.BFloat16Vector:
                                    case __1.DataType.Float16Vector:
                                        return {
                                            dim: field.dim,
                                            [elementTypeKey]: Buffer.concat(Array.isArray(vector) ? vector : [vector]),
                                        };
                                    case __1.DataType.Int8Vector:
                                        return {
                                            dim: field.dim,
                                            [elementTypeKey]: Array.isArray(vector) && typeof vector[0] === 'number'
                                                ? (0, __1.f32ArrayToInt8Bytes)(vector)
                                                : Array.isArray(vector)
                                                    ? (0, __1.int8VectorRowsToBytes)(vector)
                                                    : Buffer.from(vector.buffer, vector.byteOffset, vector.byteLength),
                                        };
                                    default:
                                        throw new Error(`ArrayOfVector element type is not supported: ${field.elementType}`);
                                }
                            };
                            keyValue = {
                                [dataKey]: {
    ...
    searchIterator(param) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const params = Object.assign(Object.assign(Object.assign({}, param.params), (param.cluster_id ? { [__1.CLUSTER_ID]: param.cluster_id } : {})), { [ITERATOR_FIELD]: true, [ITER_SEARCH_V2_KEY]: true, [ITER_SEARCH_BATCH_SIZE_KEY]: batchSize, [GUARANTEE_TIMESTAMP_KEY]: 0, [COLLECTION_ID]: collectionInfo.collectionID });
            return {
    ...
    query(data) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const queryParams = Object.assign(Object.assign({}, limits), offset);
            const orderByFields = (0, __1.normalizeOrderByFields)((_a = data.order_by_fields) !== null && _a !== void 0 ? _a : data.order_by);
            ...
            if (data.cluster_id) {
                queryParams[__1.CLUSTER_ID] = data.cluster_id;
            }
            const promise = yield (0, __1.promisify)(this.channelPool, 'Query', Object.assign(Object.assign({}, data), { output_fields: data.output_fields || ['*'], query_params: (0, __1.parseToKeyValue)(queryParams) }), data.timeout || this.timeout);
            ...
            if (promise.element_indices && promise.element_indices.length > 0) {
                if (promise.element_indices.length !== results.length) {
                    throw new Error(`element_indices length (${promise.element_indices.length}) != query result length (${results.length})`);
                }
                results = promise.element_indices.flatMap((elementIndex, i) => elementIndex.indices.data.map(elementOffset => (Object.assign(Object.assign({}, results[i]), { offset: elementOffset }))));
            }
            return {
