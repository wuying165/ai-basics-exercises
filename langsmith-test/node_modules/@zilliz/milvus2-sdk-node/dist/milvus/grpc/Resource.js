...
class Resource extends Partition_1.Partition {
    constructor() {
        super(...arguments);
        // aliases
        this.update_replicate_configuration = this.updateReplicateConfiguration;
        this.get_replicate_configuration = this.getReplicateConfiguration;
    }
    /**
     ...
     */
    updateReplicateConfiguration(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, __1.promisify)(this.channelPool, 'UpdateReplicateConfiguration', {
     ...
     */
    getReplicateConfiguration(data = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield (0, __1.promisify)(this.channelPool, 'GetReplicateConfiguration', {}, data.timeout || this.timeout);
        });
    }
    /**
