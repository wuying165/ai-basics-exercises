...
class Collection extends Database_1.Database {
    ...
    _createCollection(data) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isExternalCollection &&
                ...
                throw new Error(__1.ERROR_REASONS.CREATE_EXTERNAL_COLLECTION_AUTO_ID);
            }
            if (isExternalCollection && fields.some(field => field.is_primary_key)) {
                throw new Error(__1.ERROR_REASONS.CREATE_EXTERNAL_COLLECTION_PRIMARY_KEY);
            }
            // Check if the fields are valid.
            (0, __1.checkCollectionFieldsWithOptions)(fields, { isExternalCollection });
            ...
            const schemaTypes = {
                ...
                structArrayFieldSchemaType: this.schemaProto.lookupType(this.protoInternalPath.structArrayFieldSchema),
            };
    ...
    addCollectionFields(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return {
                error_code: __1.ErrorCode.SUCCESS,
                reason: '',
                code: 0,
                extra_info: {},
                retriable: false,
     ...
     * ```
     */
    batchDescribeCollections(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const promise = yield (0, __1.promisify)(this.channelPool, 'BatchDescribeCollection', {
                collection_name: data.collection_names,
                db_name: data.db_name,
                collectionID: data.collectionIDs || [],
            }, data.timeout || this.timeout);
            if (promise.status.error_code !== __1.ErrorCode.SUCCESS || !promise.responses) {
                return promise;
            }
            // format each collection response
            promise.responses = promise.responses.map(__1.formatDescribedCol);
            return promise;
        });
    }
    /**
     ...
     * ```
     */
    truncateCollection(data) {
        return __awaiter(this, void 0, void 0, function* () {
            (0, __1.checkCollectionName)(data);
            const promise = yield (0, __1.promisify)(this.channelPool, 'TruncateCollection', data, data.timeout || this.timeout);
            return promise;
        });
    }
    /**
    ...
    compact(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { timeout } = data, compactionReq = __rest(data, ["timeout"]);
            const res = yield (0, __1.promisify)(this.channelPool, 'ManualCompaction', Object.assign(Object.assign({}, compactionReq), { collectionID: collectionInfo.collectionID }), timeout || this.timeout);
            return res;
        });
    }
    /**
     ...
     * ```
     */
    addCollectionFunction(data) {
        return __awaiter(this, void 0, void 0, function* () {
            (0, __1.checkCollectionName)(data);
            if (!data.function) {
                throw new Error(__1.ERROR_REASONS.FUNCTION_SCHEMA_IS_REQUIRED);
            }
            const functionSchema = (0, __1.formatFunctionSchema)(data.function);
            const req = {
                collection_name: data.collection_name,
            ...
            return yield (0, __1.promisify)(this.channelPool, 'AddCollectionFunction', req, data.timeout || this.timeout);
        });
    }
    /**
     ...
     * ```
     */
    alterCollectionFunction(data) {
        return __awaiter(this, void 0, void 0, function* () {
            (0, __1.checkCollectionName)(data);
            if (!data.function_name) {
                throw new Error(__1.ERROR_REASONS.FUNCTION_NAME_IS_REQUIRED);
            }
            if (!data.function) {
                throw new Error(__1.ERROR_REASONS.FUNCTION_SCHEMA_IS_REQUIRED);
            }
            ...
            return yield (0, __1.promisify)(this.channelPool, 'AlterCollectionFunction', req, data.timeout || this.timeout);
        });
    }
    /**
    ...
    dropCollectionFunction(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield (0, __1.promisify)(this.channelPool, 'DropCollectionFunction', req, data.timeout || this.timeout);
        });
    }
    /**
     ...
     */
    refreshExternalCollection(data) {
        return __awaiter(this, void 0, void 0, function* () {
            (0, __1.checkCollectionName)(data);
            return yield (0, __1.promisify)(this.channelPool, 'RefreshExternalCollection', data, data.timeout || this.timeout);
        });
    }
    /**
     ...
     */
    getRefreshExternalCollectionProgress(data) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!data || typeof data.job_id === 'undefined') {
                throw new Error('The `job_id` property is missing.');
            }
            return yield (0, __1.promisify)(this.channelPool, 'GetRefreshExternalCollectionProgress', data, data.timeout || this.timeout);
        });
    }
    /**
     ...
     */
    listRefreshExternalCollectionJobs(data = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield (0, __1.promisify)(this.channelPool, 'ListRefreshExternalCollectionJobs', data, data.timeout || this.timeout);
        });
    }
    /**
    ...
    createSnapshot(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { snapshot_name, timeout } = data, rest = __rest(data, ["snapshot_name", "timeout"]);
            const req = Object.assign(Object.assign({}, rest), { name: snapshot_name });
            return yield (0, __1.promisify)(this.channelPool, 'CreateSnapshot', req, timeout || this.timeout);
        });
    }
    /**
     * Drop a snapshot.
    ...
    dropSnapshot(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { snapshot_name, timeout } = data, rest = __rest(data, ["snapshot_name", "timeout"]);
            const req = Object.assign(Object.assign({}, rest), { name: snapshot_name });
            return yield (0, __1.promisify)(this.channelPool, 'DropSnapshot', req, timeout || this.timeout);
        });
    }
    /**
    ...
    listSnapshots(data) {
        return __awaiter(this, void 0, void 0, function* () {
            (0, __1.checkCollectionName)(data);
            return yield (0, __1.promisify)(this.channelPool, 'ListSnapshots', data, data.timeout || this.timeout);
        });
    }
    /**
     * Describe a snapshot.
    ...
    describeSnapshot(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { snapshot_name, timeout } = data, rest = __rest(data, ["snapshot_name", "timeout"]);
            const req = Object.assign(Object.assign({}, rest), { name: snapshot_name });
            return yield (0, __1.promisify)(this.channelPool, 'DescribeSnapshot', req, timeout || this.timeout);
        });
    }
    /**
    ...
    restoreSnapshot(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { snapshot_name, source_collection_name, source_db_name, timeout } = data, rest = __rest(data, ["snapshot_name", "source_collection_name", "source_db_name", "timeout"]);
            const req = Object.assign(Object.assign({}, rest), { name: snapshot_name, db_name: source_db_name, collection_name: source_collection_name });
            return yield (0, __1.promisify)(this.channelPool, 'RestoreSnapshot', req, timeout || this.timeout);
        });
    }
    /**
     ...
     */
    getRestoreSnapshotState(data) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!data || typeof data.job_id === 'undefined') {
                throw new Error('The `job_id` property is missing.');
            }
            return yield (0, __1.promisify)(this.channelPool, 'GetRestoreSnapshotState', data, data.timeout || this.timeout);
        });
    }
    /**
     ...
     */
    listRestoreSnapshotJobs(data = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield (0, __1.promisify)(this.channelPool, 'ListRestoreSnapshotJobs', data, data.timeout || this.timeout);
        });
    }
    /**
    ...
    pinSnapshotData(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { snapshot_name, timeout } = data, rest = __rest(data, ["snapshot_name", "timeout"]);
            const req = Object.assign(Object.assign({}, rest), { name: snapshot_name });
            return yield (0, __1.promisify)(this.channelPool, 'PinSnapshotData', req, timeout || this.timeout);
        });
    }
    /**
     ...
     * @returns {Promise<ResStatus>} The response status of the operation.
     */
    unpinSnapshotData(data) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!data || typeof data.pin_id === 'undefined') {
                throw new Error('The `pin_id` property is missing.');
            }
            return yield (0, __1.promisify)(this.channelPool, 'UnpinSnapshotData', data, data.timeout || this.timeout);
        });
    }
}
