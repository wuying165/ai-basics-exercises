...
const formatFieldSchema = (field, schemaTypes, override) => {
    ...
    const _a = (0, exports.assignTypeParams)(field), { type_params, data_type, element_type, is_function_output, is_partition_key, is_primary_key, external_field } = _a, rest = __rest(_a, ["type_params", "data_type", "element_type", "is_function_output", "is_partition_key", "is_primary_key", "external_field"]);
    ...
    if ((dataType === __1.DataType.Array || dataType === __1.DataType.ArrayOfVector) &&
...
const formatCollectionSchema = (data, schemaTypes) => {
    const { collection_name, description, enable_dynamic_field, enableDynamicField, partition_key_field, functions, clustering_key_field, external_source, external_spec, do_physical_backfill, file_resource_ids, } = data;
