...
import { FloatVector, BinaryVector, SparseFloatVector, Int8Vector, Float16Vector, BFloat16Vector, FieldSchema, SearchData, PlaceholderType as PlaceholderTypeEnum } from '..';
/**
 ...
 */
export declare const buildPlaceholderGroupBytes: (milvusProto: Root, data: [SearchData] | SearchData[], field: FieldSchema, placeholderType?: PlaceholderTypeEnum) => Uint8Array;
