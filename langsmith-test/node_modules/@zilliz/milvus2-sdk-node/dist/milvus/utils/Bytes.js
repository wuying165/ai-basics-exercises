 ...
 */
const buildPlaceholderGroupBytes = (milvusProto, data, field, placeholderType) => {
    const { is_function_output } = field;
    const _placeholderType = placeholderType || field._placeholderType;
