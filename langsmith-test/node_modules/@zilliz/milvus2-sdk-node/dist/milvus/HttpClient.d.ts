...
declare const HttpClient_base: {
    ...
    new (...args: any[]): {
        ...
        listImportJobs(params: import("./types").HttpImportListReq, options?: FetchOptions | undefined): Promise<import("./types").HttpImportListResponse>;
        ...
        getImportJobProgress(params: import("./types").HttpImportProgressReq, options?: FetchOptions | undefined): Promise<import("./types").HttpImportProgressResponse>;
        config: HttpClientConfig;
        readonly baseURL: string;
        readonly authorization: string;
        readonly database: string;
