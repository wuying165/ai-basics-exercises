...
import { Constructor, FetchOptions, HttpImportListResponse, HttpImportListReq, HttpImportCreateReq, HttpImportCreateResponse, HttpImportProgressReq, HttpImportProgressResponse } from '../types';
/**
 *
...
export declare function Import<T extends Constructor<HttpBaseClient>>(Base: T): {
    new (...args: any[]): {
        ...
        listImportJobs(params: HttpImportListReq, options?: FetchOptions): Promise<HttpImportListResponse>;
        createImportJobs(params: HttpImportCreateReq, options?: FetchOptions): Promise<HttpImportCreateResponse>;
        getImportJobProgress(params: HttpImportProgressReq, options?: FetchOptions): Promise<HttpImportProgressResponse>;
