...
export declare enum RefreshExternalCollectionState {
...
export interface RefreshExternalCollectionJobInfo {
    job_id: string;
    collection_name: string;
    state: RefreshExternalCollectionState | keyof typeof RefreshExternalCollectionState;
    progress: string;
    reason: string;
    external_source: string;
    start_time: string;
...
export declare enum RestoreSnapshotState {
