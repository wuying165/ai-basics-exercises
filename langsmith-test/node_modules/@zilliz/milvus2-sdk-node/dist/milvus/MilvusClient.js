...
exports.MilvusClientSession = exports.MilvusClient = void 0;
const _1 = require(".");
...
class MilvusClientSession {
    ...
    withClusterId(params) {
        return Object.assign(Object.assign({}, params), { cluster_id: this.clusterId });
    }
    close() {
        this.closed = true;
    }
...
exports.MilvusClientSession = MilvusClientSession;
