...
export declare const CollectionProperties: {
    readonly TTL_SECONDS: "collection.ttl.seconds";
    readonly TTL_FIELD: "ttl_field";
    readonly TIMEZONE: "collection.timezone";
    readonly MMAP_ENABLED: "mmap.enabled";
};
