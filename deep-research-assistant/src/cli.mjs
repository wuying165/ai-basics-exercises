...
import { createIntelligenceDeskAgent, rootDir } from "./agent.mjs";
...
function printOutputs() {
  const sources = listMd(path.join(rootDir, "workspace/sources"));
  const reports = listMd(path.join(rootDir, "workspace/reports"));
