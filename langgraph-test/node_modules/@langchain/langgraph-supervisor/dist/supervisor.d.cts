...
import { AgentNameMode, CreateReactAgentParams, withAgentName } from "@langchain/langgraph/prebuilt";
import { RemoteGraph } from "@langchain/langgraph/remote";

//#region src/supervisor.d.ts
type OutputMode = "full_history" | "last_message";
/** @inline */
type CreateSupervisorParams<
 ...
 */
declare const createSupervisor: <
// eslint-disable-next-line @typescript-eslint/no-explicit-any
AnnotationRootT extends AnnotationRoot<any> = AnnotationRoot<{
  messages: _langchain_langgraph0.BinaryOperatorAggregate<_langchain_core_messages0.BaseMessage<_langchain_core_messages0.MessageStructure, _langchain_core_messages0.MessageType>[], _langchain_langgraph0.Messages>;
}>,
// eslint-disable-next-line @typescript-eslint/no-explicit-any
StructuredResponseFormat extends Record<string, any> = Record<string, any>>({
  agents,
  ...
  preModelHook,
  postModelHook
}: CreateSupervisorParams<AnnotationRootT, StructuredResponseFormat>) => StateGraph<AnnotationRootT["spec"], AnnotationRootT["State"], AnnotationRootT["Update"], string, AnnotationRootT["spec"], AnnotationRootT["spec"], _langchain_langgraph0.StateDefinition, unknown, unknown, unknown>;
//#endregion
export { type AgentNameMode, CreateSupervisorParams, type OutputMode, createSupervisor, withAgentName };
//# sourceMappingURL=supervisor.d.cts.map